		 			...
		 			if(resp.length > 0){
		 					Object.keys(resp).map(k=>{
		 						var obj = {};
									...
									obj['course_code']=resp[k].course_code
									obj['subject_description']=resp[k].subject_description
									obj['units']=resp[k].units
									obj['course']=resp[k].course
		 							obj['year']=resp[k].year
                  					obj['section']=resp[k].section
		 							obj['data_location']=resp[k].room
