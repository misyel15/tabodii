				...
				<div class="col-md-6">
					...
					<div class="form-group">
                                ...
                                <select class="form-control" name="subject" id="subject" required onchange="populatedesc(this.value)">
									...
									?>
							<option value="<?php echo $prow['subject'] ?>" <?php echo isset($course_code) && $course_code == $prow['subject'] ? 'selected' : '' ?>><?php echo ucwords($prow['subject']) ?></option>
						<?php endwhile; ?>
                                </select>
                                </div>
                        </div>
					<div class="form-group">
						...
						<textarea class="form-control" name="description" id="description" cols="30" rows="3"><?php echo isset($subject_description) ? $subject_description : '' ?></textarea>
					</div>
					<div class="form-group">
						<label for="" class="control-label">Units</label>
						<input type="text" name="units" id="units" class="form-control" value="<?php echo isset($units) ? $units : '' ?>">
					</div>
					...
					<div class="form-group">
                                ...
                                <select class="form-control" name="room" id="room" required onchange="populatetime(this.value)">
									...
									?>
							<option value="<?php echo $row['id'] ?>" <?php echo isset($room) && $room == $row['id'] ? 'selected' : '' ?>><?php echo ucwords($row['room_name'].", ".$row['time']) ?></option>
						<?php endwhile; ?>
                                </select>
                                </div>
                            </div>
					...
					<div class="form-group">
								...
								<select class="form-control" name="year" id="year" required onchange="populateSection(this.value)">
									<option value="0" selected><?php echo isset($year) ? $year : 'Select Year' ?></option>
								</select>
								</div>
							</div>
							<div class="form-group">
								...
								<select class="form-control" name="section" id="section" required>
									<option value="0" selected disabled><?php echo isset($section) ? $section : 'Select Section' ?></option>
								</select>
								</div>
							</div>
					<div class="form-group">
...
<script>
	...
	var data = {request:'getTime',id: room_id};
