...
<div class="container-fluid">
						...
						<table class="table table-bordered waffle no-grid" id="insloadtable">
							<thead>
								<tr>
									...
									<?php 
									$room = "";
								$rooms = $conn->query("SELECT DISTINCT room_name FROM roomlist WHERE room_id > 0 order by room_id;");
							...
							<tbody>
								<?php
								$time_id="";
								$timeslots = $conn->query("SELECT * FROM timeslot Where schedule ='MW' order by time_id asc");
				...
				<?php
						...
						foreach ($faculty as $frow) {
							...
							if($timeslot_id == $time_id ){
								$num ="";
								$roomidarr =[];
								$rooms = $conn->query("SELECT * FROM roomlist");
								$num = $rooms->num_rows;
								while($roomrow=$rooms->fetch_assoc()){
									$room = $roomrow['room_name'];
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						...
						<span class="float:right">
				<form method="POST" class="form-inline" id="printratth" action="roomassign_generatetth.php" style="margin-left: 520px;">
					...
					<div class="card-body">
						<table class="table table-bordered waffle no-grid" id="insloadtable">
							...
							<tbody>
								<?php
								$time_id="";
								$timeslots = $conn->query("SELECT * FROM timeslot Where schedule ='TTH' order by time_id asc");
								foreach ($timeslots as $timerow) {
									$time = $timerow['timeslot'];
									$time_id =$timerow['id'];
		...
		<div class="container-fluid">
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<center><h3>Friday</h3></center>
						<span class="float:right">
				<form method="POST" class="form-inline" id="printrafri" action="roomassign_generatefri.php" style="margin-left: 530px;">
			...
			<div class="col-md-12">
				<div class="card">
					...
					<center><h3>Saturday</h3></center>
						<span class="float:right">
				<form method="POST" class="form-inline" id="printrasat" action="roomassign_generatesat.php" style="margin-left: 530px;">
